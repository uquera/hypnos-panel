  ...
  return (
    <div className="flex h-screen bg-gray-50 dark:bg-slate-950 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden min-w-0">
        {/* Top bar móvil */}
        <div className="lg:hidden flex items-center gap-3 px-4 py-3 bg-white dark:bg-slate-900 border-b border-gray-100 dark:border-slate-700/50 shrink-0 shadow-sm">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-bold text-gray-900 dark:text-white">Hypnos Panel</span>
          </div>
        </div>
